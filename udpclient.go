...
// UDPClientHandler implements Packager and Transporter interface.
...
// UDPClient creates TCP client with default handler and given connect string.
...
// udpTransporter implements Transporter interface.
...
func (mb *udpTransporter) readResponse(aduRequest []byte, data []byte, recoveryDeadline time.Time) (aduResponse []byte, res readResult, err error) {
...
func (mb *udpTransporter) processResponse(data []byte) (aduResponse []byte, err error) {
...
func (mb *udpTransporter) flush(b []byte) (err error) {
